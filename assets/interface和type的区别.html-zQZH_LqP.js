...
</code></pre><p>一般来说，如果不清楚什么时候用interface/type，能用 interface 实现，就用 interface , 如果不能就用 type 。其他更多详情参看 官方规范文档</p>`,33),o=[t];function r(i,c){return s(),a("div",null,o)}const d=n(p,[["render",r],["__file","interface和type的区别.html.vue"]]);export{d as default};
